    ...
    def init_fonts(self):
        self.all_fonts = {
                ...
                "English":{ 
                    ...
                    "middle_label": tkFont.Font(family="MS UI Gothic", size=15),
...
class ResultPage(tk.Frame):
    ...
    def prints_and_gomain(self, content):
        content += "\n\n\n"
        printer = Printer('/dev/ttyS4')
        printer.prints(content = content.encode('gbk'))
        printer.close()
...
class SubjectInfoFormPage(tk.Frame):
    def __init__(self, master,mode=ONETOONE, rounds=0, inspectorId='', enterTime=0, QRcode="", DataObj={}):
        ...
        self.next_btn = tk.Button(self, text=master.conf['testing_page_section']['btn_inspect'], font=master.all_fonts[master.Languagevalue.get()]["general"], bg=button_bg, height=2,
